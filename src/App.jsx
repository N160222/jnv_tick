...
import AITestTemplatesPage from './pages/AITestTemplatesPage'; // Import new AI Test Templates Page
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/ai-test-templates" element={<AITestTemplatesPage />} /> {/* New route */}
