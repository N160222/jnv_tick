...
const AwardIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.172l-6.938 4.356a1.125 1.125 0 01-1.465-1.465L10.385 12 3.017 5.632a1.125 1.125 0 011.465-1.465l6.938 4.356 6.938-4.356a1.125 1.125 0 011.465 1.465L13.615 12l7.368 6.368a1.125 1.125 0 01-1.465 1.465L11.42 15.172z" /></svg>; // Added AwardIcon
            ...
            <main className="flex-grow py-12 sm:py-16 section-bg-gradient">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                        ...
                        <QuickActionCard icon={<TrophyIcon />} title="Leaderboard" description="See how you rank nationally." to="/leaderboard" />
                        <QuickActionCard icon={<AwardIcon />} title="Rewards & Badges" description="See your achievements and claim rewards." to="/rewards-badges" /> {/* New Quick Action */}
