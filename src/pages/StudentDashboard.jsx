            ...
            <main className="flex-grow py-12 sm:py-16 section-bg-gradient">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                        <QuickActionCard icon={<RocketLaunchIcon />} title="Start New Test" description="Jump into a fresh mock exam." />
                        <QuickActionCard icon={<ChartBarIcon />} title="View Performance" description="Analyze your progress and stats." />
                        <QuickActionCard icon={<ChatBubbleLeftRightIcon />} title="AI Tutor" description="Ask questions and clear doubts." />
                    </div>
